                ...
                <div class="col-sm-12">
                    <div class="table-responsive">
                        ...
                        <tr>
                            ...
                            <div><td><img src="./public/img/elote.jpg" class="image-responsive imagen" title="Alfabeto A "  style="width: 75px;height:75px"></td></div>
                        ...
                        <tr>
                            <div><td><img src="./public/img/nariz.jpg" class="image-responsive imagen" title="Alfabeto A "  style="width: 75px;height:75px"></td></div>
                            <div><td><audio controls>
                        ...
                        <tr>
                            <div><td><img src="./public/img/esternon.png" class="image-responsive imagen" title="Alfabeto A "  style="width: 75px;height:65px"></td></div>
                            <div><td><audio controls>
                        ...
                        <tr>
                            <div><td><img src="./public/img/cascaraDeFruta.png" class="image-responsive imagen" title="Alfabeto A "  style="width: 75px;height:75px"></td></div>
                            <div><td><audio controls>
                            <source src="./public/audios/arco.opus" type="audio/mp3">
                            </audio></td></div>
                            <div><td>Ewatl</td></div>
                            <div><td>Cascara de fruta</td></div>
                        </tr>
                        <tr>
                            <div><td><img src="./public/img/cerroDelViento.jpg" class="image-responsive imagen" title="Alfabeto A "  style="width: 75px;height:75px"></td></div>
                            <div><td><audio controls>
